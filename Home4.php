...
<?php include ('app/oop/actionsCreateClass4.php');

	$obj = new Actions();

	$result18 = $obj->select('Classrooms/4th Year/BSIT 01');
	$result19 = $obj->select('Classrooms/4th Year/BSIT 02');
	$result20 = $obj->select('Classrooms/4th Year/BSIT 03');
	$result21 = $obj->select('Classrooms/4th Year/BSIT 04');
	$result22 = $obj->select('Classrooms/4th Year/BSIT 05');
	$result23 = $obj->select('Classrooms/4th Year/BSIT 06');
 ?>
...
<div id="myModal1" class="modal1">
  ...
  <div class="modal-content1">
  	<form method="post" action="app/oop/functionsCreateClass4.php">
...
<div style="float: left;width: 100%">
	...
	<table>
		...
		<th><a href="Home3.php"><button style="background: #fff; border-radius: 5px;"><h1>Third Year</h1></button></a></th>
		<th><a href="Home4.php"><button style="background: #ffb87a; border-style: none;border-radius: 5px;"><h1>Fourth Year</h1></button></a></th>
		</tr>
	</table>
	</center>
	</div>
...
<div style="color: #fff;">	
<?php foreach($result18 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass4.php?delete19=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class4_01.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<!-------------------------------------------------------------->
<div style="color: #fff;">
<?php foreach($result19 as $key => $data): if($data): ?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass4.php?delete20=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class4_02.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a> 
...
<!-------------------------------------------------------------->
<div style="color: #fff;">	
<?php foreach($result20 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass4.php?delete21=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class4_03.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<!-------------------------------------------------------------->
<div style="color: #fff;">	
<?php foreach($result21 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass4.php?delete22=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class4_04.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<!-------------------------------------------------------------->
<div style="color: #fff;">	
<?php foreach($result22 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass4.php?delete23=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class4_05.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<?php foreach($result23 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass4.php?delete24=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class4_06.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
