...
<div id="mySidenav" class="sidenav">
  ...
  <a href="Class.php" style="font-size: 11px;"><img src="Images/cr1.png" style="width: 20px;margin-right: 10px;float: left;">ITE 314 - Advance Database System</a>
  <a href="Class2.php" style="font-size: 11px;"><img src="Images/cr2.png" style="width: 20px;margin-right: 10px;float: left;">ITE 309 - Capstone Project</a>
  <a href="Class3.php" style="font-size: 11px;"><img src="Images/cr3.png" style="width: 20px;margin-right: 10px;float: left;">ITE 306 - Integrative Programming</a>
  <a href="Class4.php" style="font-size: 11px;"><img src="Images/cr4.png" style="width: 20px;margin-right: 10px;float: left;">ITE 307 - Quantitative Methods</a>
  <a href="Class5.php" style="font-size: 11px;"><img src="Images/cr1.png" style="width: 20px;margin-right: 10px;float: left;">ITE 301 - Application Development</a>
