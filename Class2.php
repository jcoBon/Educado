...
<h1 style="float: left; font-size: 15px; margin-top: 22px; margin-left: 20px;" >ITE 309 Capstone Project</h1>
...
<div style="width: 900px; height: 100px; float: left;border-radius: 10px; margin-left: 200px;margin-top: 20px; border: 1px; border-style: solid ; border-color: #E5E7E9;padding-left: 20px;padding-top: 20px;background-image: url('Images/cl2.png'); background-size: cover;">

<p style="float: left; font-size: 30px; margin-top: 22px; margin-left: 20px; color: white; font-family:Helvetica; font-weight: bold; " >ITE 309 Capstone Project</p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl2.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 01 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl2.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 02 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl2.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 03 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl2.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 04 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl2.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 05 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl2.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 06 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl2.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 07 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl2.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 08 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl2.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 09 </p>
