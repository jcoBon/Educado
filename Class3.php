...
<h1 style="float: left; font-size: 15px; margin-top: 22px; margin-left: 20px;" >ITE 306 Integrative Programming</h1>
...
<div style="width: 900px; height: 100px; float: left;border-radius: 10px; margin-left: 200px;margin-top: 20px; border: 1px; border-style: solid ; border-color: #E5E7E9;padding-left: 20px;padding-top: 20px;background-image: url('Images/cl3.png'); background-size: cover;">

<p style="float: left; font-size: 30px; margin-top: 22px; margin-left: 20px; color: white; font-family:Helvetica; font-weight: bold; " >ITE 306 Integrative Programming</p>
<p style="float: left;position: absolute; font-size: 15px; margin-top: 60px; margin-left: 20px; color: white; font-family:Helvetica; font-weight: normal; " >3BSIT - 03</p>

</div>


<div style="width: 920px; float: left;border-radius: 10px; margin-left: 200px;margin-top: 20px; border: 1px; border-style: solid ; border-color: #E5E7E9;">
...
<div style="width: 910px;padding: 5px ; float: left;border-radius: 10px; margin-left: 200px;margin-top: 10px; border: 1px; border-style: solid ; border-color: #E5E7E9;">

<h1 style="margin-left: 30px;">Modules</h1>

<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl3.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 01 </p>

    </li>

    <a href="Module.html" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl3.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 02 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl3.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 03 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl3.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 04 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl3.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 05 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl3.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 06 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl3.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 07 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl3.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 08 </p>
...
<div class="columns">
  <ul class="price">
    <li class="header" style="background-image: url('Images/cl3.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;">Day 09 </p>
