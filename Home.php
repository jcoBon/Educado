...
<?php include ('app/oop/actionsCreateClass.php');

	$obj = new Actions();
	$result = $obj->select('Classrooms/1st Year/BSIT 01');
	$result1 = $obj->select('Classrooms/1st Year/BSIT 02');
	$result2 = $obj->select('Classrooms/1st Year/BSIT 03');
	$result3 = $obj->select('Classrooms/1st Year/BSIT 04');
	$result4 = $obj->select('Classrooms/1st Year/BSIT 05');
	$result5 = $obj->select('Classrooms/1st Year/BSIT 06');
...
<div id="myModal1" class="modal1">
  ...
  <div class="modal-content1">
  	<form method="post" action="app/oop/functionsCreateClass.php">
...
<div style="float: left;width: 100%">
	...
	<table>
		<tr>
		<th><a href="Home.php"><button style="background: #ffb87a; border-style: none;border-radius: 5px;"><h1>First Year</h1></button></a></th>
...
<div style="color: #fff;">	
<?php foreach($result as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass.php?delete1=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass.php?delete2=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class1_02.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<!-------------------------------------------------------------->
<div style="color: #fff;">	
<?php foreach($result2 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass.php?delete3=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class1_03.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<!-------------------------------------------------------------->
<div style="color: #fff;">	
<?php foreach($result3 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass.php?delete4=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class1_04.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<!-------------------------------------------------------------->
<div style="color: #fff;">	
<?php foreach($result4 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass.php?delete5=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class1_05.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<?php foreach($result5 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass.php?delete6=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class1_06.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
