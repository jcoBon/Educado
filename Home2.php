...
<?php include ('app/oop/actionsCreateClass2.php');

	$obj = new Actions();

	$result6 = $obj->select('Classrooms/2nd Year/BSIT 01');
	$result7 = $obj->select('Classrooms/2nd Year/BSIT 02');
	$result8 = $obj->select('Classrooms/2nd Year/BSIT 03');
	$result9 = $obj->select('Classrooms/2nd Year/BSIT 04');
	$result10 = $obj->select('Classrooms/2nd Year/BSIT 05');
	$result11 = $obj->select('Classrooms/2nd Year/BSIT 06');
...
<div id="myModal1" class="modal1">
  ...
  <div class="modal-content1">
  	<form method="post" action="app/oop/functionsCreateClass2.php">
...
<div>
	...
	<table>
		...
		<th><a href="Home2.php"> <button style="background: #ffb87a; border-style: none;border-radius: 5px;"><h1>Second Year</h1></button></a> </th>
...
<div style="float: left;width: 100%">
<div style="color: #fff;">	
<?php foreach($result6 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass2.php?delete7=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class2_01.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<!-------------------------------------------------------------->
<div style="color: #fff;">
<?php foreach($result7 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass2.php?delete8=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class2_02.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<!-------------------------------------------------------------->
<div style="color: #fff;">	
<?php foreach($result8 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass2.php?delete9=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class2_03.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<!-------------------------------------------------------------->
<div style="color: #fff;">	
<?php foreach($result9 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass2.php?delete10=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class2_04.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<!-------------------------------------------------------------->
<div style="color: #fff;">	
<?php foreach($result10 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass2.php?delete11=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class2_05.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
...
<?php foreach($result11 as $key => $data): if($data):?> 
...
<div class="row col-12" id=<?=$key?>>
	<div class="columns">
	  <ul class="price">
	    ...
	    <a type="button" name="del" href="app/oop/functionsCreateClass2.php?delete12=<?=$key?>"><button style="background-color: #f5f5f5; border-style: none; border-radius: 5px; padding: 5px;">DELETE</button></a>
	    <a href="Class2_06.php" style="text-decoration: none;"><li style="text-align: center;font-size: 10pt; font-family: Helvetica ; font-weight: normal; margin-top: 0px;color: #FF943F;"> Open </li></a>
