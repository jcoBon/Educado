...
<?php include ('app/oop/actionsJoinClass.php');
	...
	$result1 = $obj->select('potato/2nd year/BSIT 01');
...
<h1 style="float: left; font-size: 15px; margin-top: 22px; margin-left: 20px;" >ITE 314 Advance Database</h1>
...
<p style="float: left; font-size: 30px; margin-top: 22px; margin-left: 20px; color: white; font-family:Helvetica; font-weight: bold; " >ITE 314 Advance Database</p>
...
<div class="columns">
  <ul class="price">
    ...
    <li class="header" style="background-image: url('Images/cl1.png');"><p style="text-align: center;font-size: 15pt; font-family: Helvetica ; font-weight: bolder;"><?=$data['subjectCode']?> </p>
    </li>
